...
const SETTING_TEMPLATES: Record<string, Array<{ title: string; setting: string }>> = {
  fantasy: [
    ...
    },
    {
      ...
      setting: 'На обочине лесного тракта отряд находит тяжелораненого курьера графской стражи. Сжимая в руке запечатанный тубус с сургучной печатью, он перед потерей сознания шепчет о заговоре и просит доставить послание в цитадель.'
    },
    {
  ...
  cyberpunk: [
    {
      ...
      setting: 'Сырой подпольный рынок имплантов и нелегального софта в нижнем уровне мегаполиса. Колоритный уличный торговец-фиксер предлагает отряду контракт: встретить связного на монорельсе и забрать повреждённый инфо-кристалл корпорации «Синтек».'
    },
    {
  ...
  mafia: [
    {
      title: 'Секреты Клуба «Чёрный Кот»',
      setting: '1931 год, эпоха сухого закона. В подпольном джаз-клубе звучит саксофон, а за дальним столиком авторитетный посредник предлагает отряду сделку: помочь встретить ценный груз с Кубы на тайной лесной дороге.'
    },
    {
  ...
  scifi: [
    {
      title: 'Торговый Шаттл на Орбите Кеплера',
      setting: 'В точке гравитационного покоя дрейфует грузовой челнок бродячего скупщика артефактов. Автоматический маяк передает предложение о бартере редких минералов и технологий, но бортовой компьютер челнока фиксирует аномалию.'
    },
    {
