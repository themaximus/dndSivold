...
- ⚠️ НО ЕСЛИ:
  ...
  -> НЕМЕДЛЕННО ИНИЦИИРУЙ БОЙ! Создай противников в "activeEnemies" (с "name", "ac" ~11-16, "hpMax" ~20-50, "hpCurrent", "status": "В бою"), установи "mood": "combat", рассчитай урон по КБ и брось вызов героям!${turnGuidance}`
      : `ИДЕТ БОЕВОЕ СТОЛКНОВЕНИЕ:
Сравнивай броски атак с КБ врагов. Наноси ответные удары героям (playerUpdates). Если все враги повержены — объяви победу, опиши затишье и переведи отряд в фазу триумфа и сбора трофеев ("mood": "triumph").${turnGuidance}`;
...
8. В "activeEnemies" ОБЯЗАТЕЛЬНО включай врагов, когда идет бой, игроки атакуют, нарываются, дуэлируют или заходят в запретную зону/логово. Только при полностью мирной сцене массив "activeEnemies": [].
