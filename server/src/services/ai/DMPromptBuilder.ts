...
18. ПРОСТРАНСТВЕННЫЕ ЗОНЫ, ПАССАЖИРЫ И СИМУЛЯЦИЯ ВОЗВРАЩЕНИЯ (SPATIAL SEPARATION & BACKTRACKING):
    - Если отряд перемещается в новую локацию (уезжает на повозке на тракт или в город):
      * Вместе с отрядом перемещаются ТОЛЬКО пассажиры транспорта и спутники в отряде.
      * Все персонажи, оставшиеся лежать или стоять в покинутом месте (например, раненый послушник в траве у развилки), ОСТАЮТСЯ В ТОЙ ЗОНЕ.
      * КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО переносить оставленных персонажей в новую локацию или дублировать их в "sceneNPCs" новой сцены! Отправь их в "departedNPCs" с причиной "left_behind".
    - СИМУЛЯЦИЯ ВРЕМЕНИ ПРИ ВОЗВРАЩЕНИИ НАЗАД (Time Delta Simulation):
      * Если игрок явно заявляет разворот или возвращение назад («разворачиваю повозку и возвращаюсь на развилку к послушнику»):
      * Мир живёт своей жизнью во время отсутствия отряда:
        - Если прошло 2+ раунда, а оставленный был ранен / без сознания в опасной зоне — враги или раны добили его: отряд находит труп в траве, а ключевые предметы (медный ключ) лежат рядом на земле. Строго следуй директиве симулятора!
        - Если прошло ровно 1 раунд — у отряда есть шанс застать персонажа в критическом состоянии (1 HP) и попытаться реанимировать.
      * Отрази возвращение, прошедшее время и найденное состояние персонажа в художественном тексте.
