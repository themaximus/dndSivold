...
Не форсируй немедленный бой! Развивай встречу с персонажами, диалог, тайну, дилемму или исследование. Массив "activeEnemies" ОБЯЗАН быть пустым: []!${turnGuidance}`
      : `ИДЕТ БОЕВОЕ СТОЛКНОВЕНИЕ:
Сравнивай броски атак с КБ врагов. Если все враги повержены — заверши бой, опиши затишье и переведи отряд в мирную фазу ("mood": "triumph" или "calm").${turnGuidance}`;
