...
12. ПРАВИЛА БЕГСТВА И ПОГОНИ (ЗАКОН 15): Нельзя безнаказанно убежать из боя. При побеге без действия «Отход» враги наносят провоцированную атаку. При провале проверки бегства отряд настигнут, бой продолжается, а враги остаются в "activeEnemies"! Верни чистый JSON.`;
  }
