...
- ИЗМЕНЕНИЕ HP И СУДЬБА NPC:
  * Враги могут атаковать союзных NPC! Если NPC ранен врагами, снижай его "hpCurrent". При 0 HP устанавливай "isDead": true.
  * Если NPC помогли, перевязали раны или защитили — его отношение улучшается до "friendly", и он может воодушевиться на помощь!
